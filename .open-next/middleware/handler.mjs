...
var BuildId = "6QpNRQ_PZaPxphxIKZHLK";
...
var AppPathRoutesManifest = { "/api/ai/route": "/api/ai", "/_not-found/page": "/_not-found", "/api/ai/predict/route": "/api/ai/predict", "/api/debug-headers/route": "/api/debug-headers", "/api/all_data/route": "/api/all_data", "/api/chat/route": "/api/chat", "/api/save/route": "/api/save", "/api/ping/route": "/api/ping", "/page": "/" };
