export { E as ERC20TokenAmount, F as FacilitatorConfig, M as Money, a as PaymentMiddlewareConfig, P as PaywallConfig, b as Price, R as Resource, c as RouteConfig, e as RoutePattern, d as RoutesConfig, S as SPLTokenAmount, W as Wallet, m as moneySchema } from '../middleware-CatBMGjN.mjs';
export { C as ChainIdToNetwork, E as EvmNetworkToChainId, N as Network, a as NetworkSchema, S as SupportedEVMNetworks, b as SupportedSVMNetworks, c as SvmNetworkToChainId } from '../network-BevZ0N-7.mjs';
...
declare const facilitatorRequestSchema: z.ZodObject<{
    ...
    paymentRequirements: z.ZodObject<{
        ...
        network: z.ZodEnum<["base-sepolia", "base", "avalanche-fuji", "avalanche", "iotex", "solana-devnet", "solana", "sei", "sei-testnet", "polygon", "polygon-amoy"]>;
        ...
        scheme: "exact";
        description: string;
        network: "base-sepolia" | "avalanche-fuji" | "base" | "sei" | "sei-testnet" | "polygon" | "polygon-amoy" | "avalanche" | "iotex" | "solana-devnet" | "solana";
