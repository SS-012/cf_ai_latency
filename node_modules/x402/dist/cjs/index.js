...
async function createPaymentHeader2(client, x402Version2, paymentRequirements) {
  const paymentPayload = await createAndSignPayment(client, x402Version2, paymentRequirements);
  return encodePayment(paymentPayload);
}
async function createAndSignPayment(client, x402Version2, paymentRequirements) {
...
async function createPaymentHeader3(client, x402Version2, paymentRequirements) {
